...
export class OAuthStateManager {
  ...
  issue(pendingUserId?: string): string {
  ...
  verify(state: string): { valid: boolean; pendingUserId?: string } {
    ...
    try {
      ...
      return { valid: true, pendingUserId: typeof parsed.u === 'string' ? parsed.u : undefined };
    } catch {
      return { valid: false };
    }
  }
